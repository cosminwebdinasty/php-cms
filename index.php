...
<?php 
    ...
    $result_online = mysqli_query($connection, $query);

    $count = mysqli_num_rows($result_online);

    if($count == NULL){

        mysqli_query($connection, "INSERT INTO users_online(sesion,time) VALUES('$session', '$time')  ");
    }
    else{
